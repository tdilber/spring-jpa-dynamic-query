...
import com.beyt.jdq.mongodb.util.PresentationUtil;
import com.beyt.jdq.mongodb.util.TestUtil;
...
/**
 * MongoDB tests for ARGUMENT RESOLVERS functionality.
 * 
 ...
 * ✓ MongoDB repositories support findAll(CriteriaList) and findAll(DynamicQuery)
 ...
 * - DynamicQuery projection and pagination work with MongoDB
...
public class S10_Argument_Resolvers extends BaseMongoJoinTestInstance {
     ...
     * and that MongoDB queries are executed properly for different operator types.
     */
    @Test
