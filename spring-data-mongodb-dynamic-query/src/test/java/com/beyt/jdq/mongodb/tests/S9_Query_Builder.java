...
/**
 * MongoDB tests for QUERY BUILDER functionality.
 * 
 ...
 * 
 * MongoDB Query Builder challenges:
...
public class S9_Query_Builder extends BaseMongoJoinTestInstance {
    private @Autowired MongoAdminUserRepository adminUserRepository;
     ...
     * - Pagination
     * 
     * MongoDB equivalent would require:
