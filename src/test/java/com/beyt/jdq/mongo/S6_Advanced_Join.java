...
/**
 * MongoDB tests for ADVANCED JOIN operations.
 * 
 ...
 * 
 * MongoDB challenges for deep joins:
 ...
 * 
 * MongoDB aggregation pipeline example for roleJoin test:
 * [
...
public class S6_Advanced_Join extends BaseMongoJoinTestInstance {
     ...
     * MongoDB equivalent: Multiple $lookup with $unwind for nested array traversal
     ...
     * MongoDB equivalent: Multiple $lookup with preserveNullAndEmptyArrays option
     * Example: Find admin users where roles<roleAuthorizations<authorization<menuIcon starts with "icon"
     * 
     ...
     * - MongoDB pipeline: $lookup -> $unwind(preserveNullAndEmptyArrays) -> repeat for each level
     */
    @Test
     ...
     * MongoDB equivalent: Combination of inner and left $lookup operations
